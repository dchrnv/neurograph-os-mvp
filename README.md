...
[![Version](https://img.shields.io/badge/version-v0.63.1-blue.svg)](https://github.com/dchrnv/neurograph-os)
...
**Project Restructuring** — Централизованная конфигурация, чистая структура проекта

### Новое в v0.63.1

- ✅ **Централизация конфигурации**: `.config.sh` + `config/` с разделенными env-файлами
- ✅ **Реорганизация структуры**: docs/, scripts/, config/ - все на своих местах
- ✅ **CLI wrapper**: `./ng` для удобного доступа ко всем командам
- ✅ **Чистый корень**: только README.md и конфиг-файлы
- ✅ **Оптимизация репозитория**: внутренние документы в .gitignore (-50KB истории)

### Было в v0.63.0

- 📦 **Module Registry** - Централизованная система управления модулями
- 🔌 **Dynamic Loading** - Динамическая загрузка модулей через plugin-систему
- 📝 **Module Metadata** - Версии, зависимости, capabilities каждого модуля
- 🔐 **Module Validation** - Проверка совместимости и зависимостей
...
📚 **[Полный туториал](/docs/jupyter/jupyter_integration_tutorial.ipynb)** с 15 примерами
